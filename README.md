...
- [~] **W6–8** — ✅ backend indexer + analytics + live SSE feed; ✅ live dashboard (stat cards + real-time payment feed over SSE); ⏳ seed marketplace (3–4 services), autonomous demo agent
